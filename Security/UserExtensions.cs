...
namespace Vasont.Inspire.SDK.Security
{
    ...
    public static class UserExtensions
    {
        ...
        {
            var request = client.CreateRequest("/api/UserRoles/Users");
        ...
        {
            var request = client.CreateRequest("/api/Users/" + userId);
        ...
        {
            var request = client.CreateRequest("/api/Users?userName=" + userName + "&email=" + email + "&phone=" + phone + "&orderBy=" + orderBy + "&direction=" + direction);
        ...
        public static UserModel CreateUser(this InspireClient client, UserModel inputModel)
        {
            ...
            var request = client.CreateRequest("/api/Users", HttpMethod.Post);
        ...
        public static UserModel UpdateUser(this InspireClient client, long userId, UserModel inputModel)
        {
            ...
            var request = client.CreateRequest("/api/Users/" + userId, HttpMethod.Put);
            return client.RequestContent<UserModel, UserModel>(request, inputModel);
        }
        ...
        public static bool DeleteUser(this InspireClient client, long userId)
        {
            ...
            var request = client.CreateRequest("api/Users/" + userId, HttpMethod.Delete);
